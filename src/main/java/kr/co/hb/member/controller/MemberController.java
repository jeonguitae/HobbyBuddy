...
public class MemberController {
	 ...
	 * 
	 * @ResponseBody public HashMap<String, Object> city(Model model, @RequestParam
	 * String city) { logger.info("도시 변경 : "+city); HashMap<String, Object> map =
	 * new HashMap<String, Object>(); ArrayList<MemberDTO> area =
	 * service.area(city); map.put("area", area); return map; }
	 */
	...
	public String mypage(Model model, HttpSession session) {
		/*
		 * ArrayList<MemberDTO> city = service.city(); logger.info("city : " + city);
		 * model.addAttribute("city",city);
		 */
		String id = (String) session.getAttribute("loginId");
	...
	@ResponseBody
	public HashMap<String, Object> myHobbyDel(
			@RequestParam(value = "myHobbyDelList[]") ArrayList<String> myHobbyDelList) {
